...
├── .gitignore              ✓ Committed
├── README.md               ✓ Committed
├── Vagrantfile            ✓ Committed
├── docs/                  ✓ Committed (folder)
│   ├── SETUP-GUIDE.md         ✓ Committed
│   ├── CLUSTER-INFO.md        ✓ Committed
│   ├── LOKI-GUIDE.md          ✓ Committed
│   ├── GIT-QUICK-REFERENCE.md ✓ Committed
│   └── .gitignore-README.md   ✓ Committed
├── scripts/               ✓ Committed (folder)
│   ├── setup-cluster.sh       ✓ Committed
│   ├── install-k3s-master.sh  ✓ Committed
│   ├── install-k3s-worker.sh  ✓ Committed
│   ├── install-observability.sh ✓ Committed
│   ├── verify-cluster.sh      ✓ Committed
│   └── ssh-nodes.sh           ✓ Committed
...
├── secrets.yaml          ✗ Ignored (real secrets)
├── id_rsa                ✗ Ignored
└── .DS_Store             ✗ Ignored
```
