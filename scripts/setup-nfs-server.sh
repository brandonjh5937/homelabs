...
/nfs/shared      192.168.5.0/24(rw,sync,no_subtree_check,no_root_squash)
/nfs/grafana     192.168.5.0/24(rw,sync,no_subtree_check,no_root_squash)
/nfs/prometheus  192.168.5.0/24(rw,sync,no_subtree_check,no_root_squash)
/nfs/loki        192.168.5.0/24(rw,sync,no_subtree_check,no_root_squash)
/nfs/alertmanager 192.168.5.0/24(rw,sync,no_subtree_check,no_root_squash)
EOF
...
exportfs -v
echo ""
echo "NFS server is ready at: 192.168.5.200"
echo ""
